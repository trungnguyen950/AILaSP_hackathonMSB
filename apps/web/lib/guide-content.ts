...
export const PAGES: Record<string, GuidePage> = {
  ...
  "sign/upload": {
    ...
    blocks: [
      ...
      { type: "h2", text: "Lấy Zalo Chat ID", anchor: "zalo-chat-id" },
      { type: "p", text: "Để gửi hồ sơ đã ký cho khách hàng qua Zalo, bạn cần có Zalo chat_id. Thực hiện theo các bước sau:" },
      {
        type: "steps",
        items: [
          { title: "Mời bot vào nhóm/chat", desc: "Mở link invite bot Zalo: https://bot.zaloplatforms.com/groups/invite/bot.NZSPzvFP — bot sẽ tự động tham gia." },
          { title: "Nhắn bất kỳ cho bot", desc: "Gửi 1 tin nhắn bất kỳ (ví dụ: \"hello\") đến bot trong Zalo. Bot sẽ tự động phản hồi và ghi nhận chat_id của bạn." },
          { title: "Sao chép chat_id", desc: "Bot phản hồi kèm chat_id của cuộc hội thoại. Sao chép chat_id này." },
          { title: "Dán vào ô Zalo chat_id", desc: "Trang Ký Số → dán chat_id vào ô \"Zalo chat_id\" → bấm 💬 Gửi Zalo Bot." },
        ],
      },
      { type: "callout", variant: "tip", title: "Link invite bot Zalo", text: "Bot Zalo SmartForm AI: https://bot.zaloplatforms.com/groups/invite/bot.NZSPzvFP — nhắn bất kỳ để lấy chat_id tự động." },
  ...
  "dashboard/overview": {
    ...
    description: "Business KPI realtime cho quản lý ngân hàng — cập nhật mỗi 3 giây",
    section: "Dashboard",
    icon: "📊",
    blocks: [
      { type: "h2", text: "Mục đích", anchor: "purpose" },
      { type: "p", text: "Dashboard Điều hành Hồ sơ — tổng hợp business KPI realtime cho quản lý ngân hàng (Phó TGĐ, Trưởng BU, Quản lý RM). Cập nhật mỗi 3 giây. Không hiển thị chỉ số kỹ thuật IT — tập trung vào: hồ sơ xử lý, hiệu quả vận hành, giá trị kinh doanh, phân khúc khách hàng, FDI." },
      { type: "callout", variant: "info", title: "LIVE", text: "Dữ liệu realtime cập nhật mỗi 3 giây. Hook useMetrics() tách biệt phần data, dễ thay API thật (MSB data warehouse, Core Banking, CRM) mà không đổi UI." },
      { type: "h2", text: "9 nhóm chỉ số", anchor: "sections" },
      { type: "h3", text: "1. KPI Tổng quan" },
      {
        type: "table",
        headers: ["KPI", "Metric", "Ý nghĩa"],
        rows: [
          ["📋 Tổng hồ sơ đã xử lý", "hồ sơ", "Tổng số hồ sơ Agent đã xử lý (cộng dồn realtime)"],
          ["✅ Nộp đúng lần đầu", "%", "Tỷ lệ hồ sơ READY — First-Time-Right"],
          ["⏱️ Thời gian xử lý TB", "phút/hồ sơ", "Thời gian trung bình xử lý 1 hồ sơ"],
          ["⚠️ Tỷ lệ hồ sơ trả lại", "%", "Tỷ lệ hồ sơ cần bổ sung / bị trả lại"],
        ],
      },
      { type: "h3", text: "2. Giá trị kinh doanh (AEV)" },
      { type: "p", text: "Tiết kiệm luỹ kế (VND), tiết kiệm hôm nay, giờ RM tiết kiệm, AEV dự kiến/năm — annualized từ tiết kiệm cumul." },
      { type: "h3", text: "3. Trạng thái hồ sơ" },
      { type: "p", text: "Donut chart 3 segment: READY (xanh), MISSING (amber), NEED REVIEW (xanh dương) + chi tiết số lượng + insight." },
      { type: "h3", text: "4. Xu hướng realtime" },
      { type: "p", text: "Line chart: Phiên khách hàng đang hoạt động + Thời gian xử lý TB (phút/hồ sơ)." },
      { type: "h3", text: "5. Phân khúc khách hàng" },
      { type: "p", text: "Donut + Bar chart: KH Doanh nghiệp, KH FDI (song ngữ VI/EN), KH Cá nhân." },
      { type: "h3", text: "6. Phễu ký & Nguồn form" },
      { type: "p", text: "Funnel chart: Form Selected → Data Collected → QC Passed → Signed. Donut: Chat (persona) vs Forms (AI Fill) vs Forms (download)." },
      { type: "h3", text: "7. Form dùng nhiều & Xu hướng ký" },
      { type: "p", text: "Horizontal bar chart: Top 9 form dùng nhiều nhất. Bar chart: Daily Sign Trend 14 ngày." },
      { type: "h3", text: "8. Hiệu suất chuyên viên RM" },
      { type: "p", text: "Bảng top 5 RM: tên, số hồ sơ xử lý, tỷ lệ READY, progress bar hiệu suất." },
      { type: "h3", text: "9. Khách hàng & FDI" },
      {
        type: "table",
        headers: ["KPI", "Metric", "Ý nghĩa"],
        rows: [
          ["📊 NPS", "điểm", "Net Promoter Score (−100 đến 100)"],
          ["⭐ CSAT", "/ 5.0", "Customer Satisfaction Score"],
          ["🔄 KH quay lại", "KH", "Số khách hàng dùng SmartForm lần 2+"],
          ["🌐 FDI đã phục vụ", "KH", "Doanh nghiệp FDI — segment chiến lược (song ngữ VI/EN)"],
        ],
      },
      { type: "callout", variant: "tip", text: "Charts 100% SVG thuần — zero external dependency, tương thích static export. Dễ thay thế mock data bằng API thật (MSB data warehouse, Core Banking, CRM)." },
